...
static bool waitForIngredients (int id)
{
    ...
    // semUp -> notificações podem ser enviadas
    ...
    // descobrir o id dos ingredientes que não aquele que o smoker tem sempre
    ...
    /* TODO: insert your code here */
    if(sh->fSt.closing){
        // caso a notificação fosse para fechar
...
static void smoke(int id)
{
    ...
    usleep(smokingTime); 
    // tempo que o smoker tira para fumar
