...
static bool waitForIngredient(int id)
{
    ...
    /* TODO: insert your code here */
    // esperar por uma NOTIFICAÇÃO do agente...
    ...
    if(sh->fSt.closing){
        ...
        // informar o smoker através do wait2Ings
...
static int updateReservations (int id)
{
    ...
    /* TODO: insert your code here */
    // dar update nas reservations, o id que vem é o do ingrediente que foi feito
    // verificar se um smoker pode fazer um cigarro - se sim, ret = id desse smoker
    //                                              - se não, ret = -1
    sh->fSt.st.watcherStat[id] = UPDATING;
    saveState(nFic, &sh->fSt);

    sh->fSt.reserved[id]++;
    // um smoker estará pronto se houver 2 ingredientes reservados. entre 0, 1 e 2
    // o número que não for o dos ing reservados é o smoker a informar e o id a retornar
...
static void informSmoker (int id, int smokerReady)
{
    ...
    /* TODO: insert your code here */
    // dar update no estado para INFORMING
